...
let friends = ["Maheen", "Iqra", "Abdullah", "Ahmed"];
console.log(friends[4]); //Intensional Error: Array index error
console.log(friends[3]); //Correcting the error by acessing the valid index
